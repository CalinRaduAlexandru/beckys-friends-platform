...
Registru editorial canonic pentru aplicația locală Becky. Fiecare idee există într-o singură secțiune și se mută, nu se copiază: **De trecut** → **Păstrate** sau **Nefolosite**. O idee din „Păstrate” nu se mai propune ca nouă, iar una din „Nefolosite” nu se mai sugerează. Dacă o activitate este modificată, se actualizează aici și se păstrează o singură formă finală.

Filtrarea după numărul de participanți este definită în `data/parent-experiences.json`, prin `groupSizes`: `small` pentru 2–3 persoane și `large` pentru 4+ persoane. O activitate poate aparține ambelor categorii; cele exclusive pentru `large` primesc discret marcajul „4+” în aplicație.
...
- **Două adevăruri și o minciună** — mutată pentru o etapă ulterioară; nu apare în caruselul activ acum.

## Nefolosite

- **Votează în secret** — scoasă din selecția actuală la cererea lui Radu.
- **Inventăm o reclamă absurdă** — scoasă din selecția actuală la cererea lui Radu.
- **Poveste din 3 cuvinte** — scoasă din selecția actuală la cererea lui Radu.
